...
A powerful NPM package that distributes customizable AI agent configurations to your projects. Get the right agents, skills, and workflows based on your project type—frontend, backend, mobile, or any of 9 supported types.

**Stop copying configurations manually. Start with intelligent, project-specific AI assistance.**
